export default function StatsCard({ label, value, icon, iconColor = 'text-primary/50' }) {
    return (
        <div className="component-float-in bg-surface-light dark:bg-surface-dark p-2 md:p-5 rounded-lg md:rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col justify-center">
