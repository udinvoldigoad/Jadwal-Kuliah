...
export default function CourseCard({ course, isLive = false, onEdit, onDelete }) {
    ...
    return (
        <div className={`group bg-surface-light dark:bg-surface-dark rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md hover:border-primary/50 transition-all cursor-pointer relative ${menuOpen ? 'z-50' : ''}`}>
            {/* Left accent bar */}
